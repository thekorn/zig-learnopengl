...
pub fn main() !void {
    ...
    var shader = try Shader.create(@embedFile("res/shaders/6.7_exercise2.vert"), @embedFile("res/shaders/6.7.frag"));
    defer shader.deinit();
    ...
    while (c.glfwWindowShouldClose(window) == c.GL_FALSE) {
        ...
        const hor_offset: f32 = @floatCast(@sin(time_value * 2));

        shader.set_float("horOffset", hor_offset);
